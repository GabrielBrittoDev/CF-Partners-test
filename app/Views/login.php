...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="<?= base_url('assets/template') ?>/css/notifications/toastr/toastr.css"></head>
<body>
<script>
    /**
...
<div class="page-wrapper auth">
    <div class="page-inner bg-brand-gradient">
        <div class="page-content-wrapper bg-transparent m-0">
            ...
            <div class="flex-1" style="background: url(<?= base_url('assets/template')?>/img/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col col-md-6 col-lg-7 hidden-sm-down">
                            <h2 class="fs-xxl fw-500 mt-4 text-white">
                                ...
                                <small class="h3 fw-300 mt-3 mb-5 text-white opacity-60">
                                    Here, you have complete control over managing your users. With our intuitive interface, you can easily view, edit, deactivate, and delete user accounts.
                                </small>
                            </h2>
                            <div class="d-sm-flex flex-column align-items-center justify-content-center d-md-block">
                                <div class="d-flex flex-row opacity-70">
                                    <a target="_blank" href="https://github.com/magin02" class="mr-2 fs-xxl text-white">
                                        <i class="fab fa-github-square"></i>
                                    </a>
                                    <a target="_blank" href="https://www.linkedin.com/in/gabriel-leal-2b6663195/" class="mr-2 fs-xxl text-white">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                <form id="js-login" novalidate="" action="/authenticate" method="POST">
                                    <div class="form-group">
                                        <label class="form-label" for="username">Username</label>
                                        <input type="email" name="email" id="username" class="form-control form-control-lg" placeholder="your username or email" required>
